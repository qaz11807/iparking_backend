...
var checkUserIsExist = function (username) { return __awaiter(void 0, void 0, void 0, function () {
    var user, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, User.findOne({ where: { username: username } })];
            case 1:
                user = _a.sent();
...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var payload, user, isExist, salt, hash, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 7, , 8]);
                ...
                return [4 /*yield*/, checkUserIsExist(user.username)];
            case 1:
                isExist = _a.sent();
            ...
            case 4:
                hash = _a.sent();
                return [4 /*yield*/, User.create(__assign(__assign({}, user), { password: hash }))];
            case 5:
                _a.sent();
                res.json({
